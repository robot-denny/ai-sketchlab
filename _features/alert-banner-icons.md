...
**Source spec**: `_work/shipped/alert-banner-icons/spec.md`
...
- [x] 2026-04-09 — default icons per severity + curated icon override dropdown (spec: `_work/shipped/alert-banner-icons/spec.md`)
