...
**Source**: imageless-placeholder increment — spec/plan authored under the cantrip toolkit trial
(`cantrip-trial` branch, `_work/placeholder-graphics-imageless-cards/`); the behavior ships to
master independently. Remaining rules backfilled from the implementation (2026-08-04).
...
- [x] Placeholder graphics for imageless article cards — shipped 2026-08-04 (spec/plan under the `cantrip-trial` branch)
