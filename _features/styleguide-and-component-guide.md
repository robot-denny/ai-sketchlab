...
**Source spec**: `_work/shipped/consolidated-guides/spec.md` (consolidation); `_work/shipped/living-style-guide/spec.md` (original)
...
- [x] 2026-04-29 — Initial styleguide page with brand summary and hardcoded showcase sections (spec: `_work/shipped/living-style-guide/spec.md`)
