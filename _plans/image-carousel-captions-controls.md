...
> Source spec: [../_specs/image-carousel-captions-controls.md](../_specs/image-carousel-captions-controls.md)
> Living feature: [../_features/image-carousel-captions-controls.md](../_features/image-carousel-captions-controls.md)

## Context

The Image Carousel Row block was built in the previous iteration ([_plans/image-carousel-block.md](../../Sites/umbraco-17-demo-site/_plans/image-carousel-block.md)) using a Bootstrap 5 carousel with a multi-media picker (`images`) and a custom JS layer for accessibility. It works, but two things hold it back:
...
| `_plans/image-carousel-block.md` | Style reference for this plan (numbered steps, paste-ready prompts, TDD framing) |
