# Demo Site Context — retired

> **This document is retired.** It was a February 2026 "living document" capturing early intent while the site was still being built out. Its content is now stale (it predates the shared-block refactor, the RCL split, and most shipped capabilities) and has been superseded by the docs below. It is kept as a signpost so existing links don't 404 — do not add new content here.
