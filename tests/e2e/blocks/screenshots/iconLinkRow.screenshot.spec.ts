...
// /guides/component-guide/ page as a social-links demonstration), un-skip
// this test and regenerate the baseline via `update-snapshots.yml`.

test.describe('Screenshot: Block List iconLinkRow', () => {
  test.skip(
    true,
    'TODO: iconLinkRow has no canonical render surface yet. Add it to /guides/component-guide/ and un-skip this test.',
  );
